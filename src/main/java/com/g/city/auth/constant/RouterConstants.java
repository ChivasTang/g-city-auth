...
public class RouterConstants {
    ...
    public final static String PROFILE_ROUTER_MARKER = "/" + APP_VERSION_NO + "/api/user/profile";
    ...
    //public static final AntPathRequestMatcher PROFILE_MATCHER = AntPathRequestMatcher.antMatcher(HttpMethod.POST,
    // PROFILE_ROUTER_MARKER);
}
